    ...
    for _, batch in tqdm(enumerate(train_dataloader), 'joint phase:'):
        ...
        if scaler is not None:
            with torch.cuda.amp.autocast():
                ...
                sim = 1+losses.NCC_metric(device='cuda').loss(synths_warped[0],ct_fixed_synths[0].detach())
...
def save_model(G, D_MR, D_CBCT, opt_G, opt_D_MR, opt_D_CBCT, args, epoch):
    torch.save({
        ...
        'args': args
    }, os.path.join(args['save_path'], 'JSREDLuns_all_ncc_{}_ep{}.pt'.format(args['exp_name'], epoch)))
...
if __name__ == '__main__':
    ...
    # Prepare Tensorboard
    boardio = SummaryWriter(log_dir='./log/JSRCascade_ncc_{}_{}_{}_{}'.format(args['exp_name'], args['lambda_l1'],
