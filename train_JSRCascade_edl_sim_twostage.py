    ...
    for _, batch in tqdm(enumerate(train_dataloader), 'reg phase:'):
        ...
        if scaler is not None:
            with torch.cuda.amp.autocast():
                ...
                mr_syn = synths_warped[0]
                cbct_syn = ct_fixed_synths[0]
                ...
                # Total Loss
                loss_G = loss_reg + args['lambda_unc'] * loss_unc
...
def save_model(G, D_MR, D_CBCT, opt_G, opt_D_MR, opt_D_CBCT, args, epoch):
    torch.save({
        ...
        'args': args
    }, os.path.join(args['save_path'], 'JSREDLuns_twostage_sim_newflow_1n1_{}_ep{}.pt'.format(args['exp_name'], epoch)))
...
if __name__ == '__main__':
    ...
    # Prepare Tensorboard
    boardio = SummaryWriter(log_dir='./log/JSREDL_tssim_{}_{}_{}_{}'.format(args['exp_name'], args['lambda_l1'],
    ...
    for i in range(args['schedule'][1]):
        reg_loss, sim_loss, smoothness_loss,unc_loss = train_reg_epoch(args, G, train_dataloader, opt_G, device, scaler)
