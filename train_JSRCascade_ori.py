...
def save_model(G, D_MR, D_CBCT, opt_G, opt_D_MR, opt_D_CBCT, args, epoch):
    torch.save({
        ...
        'args': args
    }, os.path.join(args['save_path'], 'JSRCascade_rnewflow_twostage_{}_ep{}.pt'.format(args['exp_name'], epoch)))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--pretrained", type=str, default='JSRCascade_synthesis_l1100_multi0.3_reg100_seg6_ep99.pt', help='dir to pretrain model')
